...
void Init(HWND hwnd)
{
     ...
     textureSprite1 = LoadTexture("Move.png");
     textureSprite2 = LoadTexture("Jump.png");
     textureSprite3 = LoadTexture("Static.png");
     ...
     hero.x = 1285.0f;  // Начальная позиция по X
     hero.y = groundLevel-120;  // Начальная позиция по Y
     hero.isAirborne = false;
}
